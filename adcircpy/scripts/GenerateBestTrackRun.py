...
class GenerateBestTrackRun(object):
    ...
    @staticmethod
    def parse_args():
        description = "Program to generate ADCIRC best track hindcast run. "
        description += "Get the storm_id from https://www.nhc.noaa.gov/data/"
        description += "hurdat/hurdat2-1851-2018-051019.txt"
        parser = argparse.ArgumentParser(description=description)
        parser.add_argument("fort14", help="Path to mesh file.")
        parser.add_argument("storm_id", help="ATCF storm id.")
        parser.add_argument(
            "output_directory",
