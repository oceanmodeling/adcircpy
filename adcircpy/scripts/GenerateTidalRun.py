...
class GenerateTidalRun(object):
    ...
    def __init__(self):
        ...
        # mesh = AdcircMesh.open(self.args.fort14)
        # print(mesh)
    ...
    @property
    def fort15_kwargs(self):
        return self.args.fort15_kwargs


def main():
    GenerateTidalRun()
    # args, fort15_kwargs = parse_args()
    # mesh = AdcircMesh.open(args.fort14)
    # tidal_forcing = TidalForcing()
    # tidal_forcing.start_date = 
    # tidal_forcing.end_date = 
    # adcirc_run = AdcircRun(mesh, tidal_forcing)
    # adcirc_run.tidal_forcing = TidalForcing()
