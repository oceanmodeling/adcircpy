...
def log_level(parser):
    ...
    log_level.add_argument('--log-level-info', nargs='?', const=logging.INFO,
                           dest='log_level')
    log_level.add_argument(
        '--log-level-debug', nargs='?', const=logging.DEBUG, dest='log_level'
    )
    log_level.add_argument(
        '--log-level-warning', nargs='?', const=logging.WARNING,
        dest='log_level'
    )
