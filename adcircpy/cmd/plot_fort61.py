...
# class PlotElevationStationsOutput:
...
#             description="Program to see a quick plot of an ADCIRC mesh.")
#         parser.add_argument(
#             "fort61", help="Path to ADCIRC fort.61 or fort.61.nc file.")
#         show = parser.add_mutually_exclusive_group(required=False)
#         show.add_argument(
#             '--show', dest='show', action='store_true',
#             help='Shows plots to screen as they are generated (default).')
...
#     def fort61(self):
#         try:
#             return self.__fort61
#         except AttributeError:
#             self.__fort61 = ElevationElevationStationsOutput
#             return self.__fort61