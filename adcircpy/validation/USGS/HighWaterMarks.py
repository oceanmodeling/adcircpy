...
class HighWaterMarks(OrderedDict):
    ...
    def __init__(
        self, event_name, event_year, filter_dict=default_filter, **station_data
    ):
    ...
    def from_event_name(cls, event_name, filter_dict=None):
        event_name, event_year, cls.params["Event"] = cls._get_event_id_from_name(
            event_name
        )
    ...
    def make_plot(
        self, axes=None, vmin=None, vmax=None, extent=None, epsg=None, **kwargs
    ):
        if axes is None:
            fig = plt.figure()
