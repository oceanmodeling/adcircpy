...
def _read_ascii(self):
  # path, fort14=None, datum='MSL', epsg=4326, output_type=None
  self._load_fort14()
  self._load_fort15()
  f = open(self._path)
  ...
  if line_is_int == True:
    for i in range(_num):
      next(f)
    num_of_datasets = f.readline()

    # Probably harmonic constituent, fort.51 or fort.53
    # fort.51 should require a fort.15 or alternatively a list of station names
    # fort.53 should require a fort.14 
