...
class AdcircMesh(TrimeshSurface):
  def __init__(self, x, y, elements, values, epsg, vertical_datum, nodeID=None, elementID=None, description=None, fort13=None, spinup_attributes=None, runtime_attributes=None, datum_grid=None, **Boundaries):
    super(AdcircMesh, self).__init__(x, y, elements, values, epsg, nodeID, elementID, vertical_datum, **Boundaries)
    self._description = description
    self._init_fort13(fort13, spinup_attributes, runtime_attributes)
  ...
  @classmethod
  def from_fort14(cls, fort14, epsg=4326, vertical_datum='LMSL', fort13=None, spinup_attributes=None, runtime_attributes=None, datum_grid=None):
    """ Initiliazes AdcircMesh class from fort14 file. """
    return cls(fort13=fort13, spinup_attributes=spinup_attributes, runtime_attributes=runtime_attributes, epsg=epsg, vertical_datum=vertical_datum, **cls.parse_fort14(fort14))
  ...
  # def make_plot(self, extent=None, axes=None, title=None, colors=256, cbar_label='elevation [m]', figsize=None, vmin=None, vmax=None, show=False):
  #   self._init_fig(axes, figsize)
  #   self._init_vmin(vmin)
  #   self._init_vmax(vmax)
  #   self._init_cmap_levels('topobathy', colors)
  #   self._init_norm()
  #   self._axes.tricontourf(self.x, self.y, self.elements, self.values, levels=self._levels, cmap=self._cmap, norm=self._norm, extend='both')
...
if __name__ == '__main__':
  import os
  AdcircMesh.from_fort14(os.getenv('FORT14_PATH'))