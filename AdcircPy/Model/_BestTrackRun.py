...
class _BestTrackRun(_AdcircRun):
    def __init__(self, AdcircMesh, storm_id, start_date=None, end_date=None,
                 spinup_days=None, constituents='all', netcdf=True,
                 ElevationGlobalOutput=None, VelocityGlobalOutput=None,
                 MeteorologicalGlobalOutput=None, ElevationStationsOutput=None,
                 VelocityStationsOutput=None,
                 MeteorologicalStationsOutput=None, **fort15):
        WindForcing = BestTrackForcing(storm_id, start_date, end_date)
        TidalForcing = _TidalForcing(WindForcing.start_date,
                                     WindForcing.end_date,
                                     spinup_days)
        super(_BestTrackRun, self).__init__(
            AdcircMesh, TidalForcing, WindForcing, netcdf,
            ElevationGlobalOutput, VelocityGlobalOutput,
            MeteorologicalGlobalOutput, ElevationStationsOutput,
            VelocityStationsOutput, MeteorologicalStationsOutput, **fort15)
